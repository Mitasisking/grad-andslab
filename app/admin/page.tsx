...
export default function DashboardPage() {
  ...
  // Inject Google Maps Places API for Address Autocomplete (with duplicate prevention)
  useEffect(() => {
  ...
  const handleCheckout = async () => {
      ...
      .insert([
        {
          ...
          total_cards: pendingList.length,
          total_declared_value: pendingList.reduce((sum, s) => sum + Number(s.declared_value), 0),
    ...
    const pendingIds = pendingList.map(sub => sub.id)
  ...
  const grandTotal = totalBaseCost + totalMarkup
  const totalDeclared = pendingSubmissions.reduce((sum, sub) => sum + Number(sub.declared_value), 0)
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white p-8 pb-20">
                      ...
                      <div className="text-right">
                        ...
                        <div className="flex justify-end gap-3 mt-2">
                          ...
                          <button 
                            ...
                            className="text-[11px] text-slate-400 hover:text-red-400 font-medium transition"
                          >
                            Delete
                          </button>
                        </div>
      ...
      {/* Shipping Profile Section with Google Maps Integration */}
                      ...
                      <div className="flex justify-end">
                        <div className="w-64 space-y-1.5 text-xs text-slate-400">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="italic text-slate-500">Pending DHL Rates</span>
                          </div>
