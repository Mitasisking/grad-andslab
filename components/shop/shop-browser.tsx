...
/** Owns the stackable language/set/grader/price filters and re-derives the visible product list from them — the category tab above this stays server/URL-driven (app/shop/page.tsx), these are purely client-side on top of whatever that query already returned. */
