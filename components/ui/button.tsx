...
const buttonVariants = cva(
  // duration-200 ease-fluid (app/globals.css) replaces the default linear
  // transition timing site-wide, and active:scale gives every button a
  // gentle press-down on click -- both part of the 2026-09-24 UX polish
  // pass, purely presentational, no variant/size/logic changes below.
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 ease-fluid active:scale-[0.97] disabled:pointer-events-none disabled:opacity-50 disabled:active:scale-100 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
